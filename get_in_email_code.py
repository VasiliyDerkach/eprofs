...
cod_email_subject = site_ifo['cod_email_subject']
cod_email_str_after_username = site_ifo['cod_email_str_after_username']
    ...
    for msg_num in unread_msg_nums:
        ...
        if subject==cod_email_subject:
            ...
            for i,t in enumerate(txt):
                tx = t.decode('utf-8')
                pk = tx.find(in_mail_name + cod_email_str_after_username)
                ...
                po = re.search('(?<=' + cod_email_str0 + cod_email_str1, t.decode('utf-8'))
